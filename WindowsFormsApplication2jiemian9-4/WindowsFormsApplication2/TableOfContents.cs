...
namespace WindowsFormsApplication2
{
    class TableOfContents
    {
       ...
       */
         ...
         */
        public Dictionary<string, int> generateTestTextTreeView(Dictionary<string, List<TermContainer>> result, TreeView tv, TreeView regTreeView)
        {
            Dictionary<string, int> dict;
            generateTreeView(result, tv);
            dict = colorTreeView(tv,regTreeView);
            tv.Update();
            tv.ExpandAll();
            tv.Nodes[0].EnsureVisible();
            regTreeView.Update();
        ...
        /// <param name="regTreeView"></param>
        private Dictionary<string, int> colorTreeView(TreeView testTreeView, TreeView regTreeView)
        {
            int error = 0;
            int spare = 0;
            int miss = 0;
            ...
            if (regcount >= testcount)
            {
                ...
                return colorSamePart(testTreeView, regTreeView, ref error, ref spare, ref miss, testcount);
            }
            else if(regcount < testcount)
            {
                ...
                //////
                return colorSamePart(testTreeView, regTreeView, ref error, ref spare, ref miss, regcount);
            }
            return null;
        }
        ...
        private Dictionary<string, int> colorSamePart(TreeView testTreeView, TreeView regTreeView, ref int error, ref int spare, ref int miss, int testcount)
        {
