...
namespace WindowsFormsApplication2
{
    public partial class Form1 : Form
    {
        ...
        private void initTableList()
        {
            ...
            cbxTableList.Items.Add("城市现状用地平衡表－规划");
            ...
            else
            {
                ...
                if (cbxRegDoc.Items.Contains(regFileName))
                {
                    if (isTextMode())
                    {
                        ...
                        writeTocTOListBox(testTOCContents, testTreeView, regTreeView);
        ...
        private void writeTocTOListBox(Dictionary<string, List<TermContainer>> result, TreeView tv, TreeView regTreeView)
        {
            tv.Nodes.Clear();
            int error = 0;
            int spare = 0;
            ...
            Dictionary<string, int> dict = tableOfContents.generateTestTextTreeView(result, tv, regTreeView);
